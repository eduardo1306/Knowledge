<template>
  <div class="article-admin">
    <b-form>
      ...
      <b-form-group label="Imagem(URL): " v-if="mode === 'save'" label-for="article-imageUrl">
        <b-form-input
          id="article-imageUrl"
          type="text"
      ...
      <b-form-group label="Conteúdo: " v-if="mode === 'save'" label-for="category-content">
        <VueEditor v-model="article.content" v-if="mode === 'save'" placeholder="Informe o Conteúdo do Artigo..." />
      </b-form-group>
